    ...
    return (
      ...
      <ScrollView style={styles.scrollView}>
        ...
        {`“Não vos enganeis. As más companhias corrompem os bons costumes.” 1Co 15:33 (AXXI)
         ...
         <Text style={styles.subtitle}>Más companhias impedem o mover de Deus
         </Text>
         <Text style={styles.texto}>  
         ...
         Está claro no texto que aquelas pessoas incrédulas impediram a manifestação plena do poder de Deus através de Cristo. 
